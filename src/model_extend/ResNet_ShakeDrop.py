...
class ResNet_ShakeDrop_9(nn.Module):
    
    def __init__(self, conv1_in_channel=9, depth=18, num_class=6,
                 shakedrop=False, block=ResBlock):
        super(ResNet_ShakeDrop_9, self).__init__()
...
if __name__ == '__main__':
    ...
    model = ResNet_ShakeDrop_9(depth=18, shakedrop=True).cuda()
    summary(model, torch.zeros(1,9,174,19).cuda())
'''