...
EFILE="output/single/ISMIR2014_sdt6_resnet_${NORM}k${WS}_l${HL1}h${HS1}b{BIDIR1}_e${END_EPOCH}b${BATCH}_${FEAT}.csv"
VFILE="output/total/ISMIR2014_sdt6_resnet_${NORM}k${WS}_l${HL1}h${HS1}b{BIDIR1}_e${END_EPOCH}b${BATCH}_${FEAT}.csv"
TEFILE="output/train_single/ISMIR2014_sdt6_resnet_${NORM}k${WS}_l${HL1}h${HS1}b{BIDIR1}_e${END_EPOCH}b${BATCH}_${FEAT}_sample.csv"
TVFILE="output/train_total/ISMIR2014_sdt6_resnet_${NORM}k${WS}_l${HL1}h${HS1}b{BIDIR1}_e${END_EPOCH}b${BATCH}_${FEAT}_sample.csv"
TROUTDIR="output/sdt6_resnet_est"
...
#for num in $(seq 1 82)
#do
#    python3 eval_resnet_fmeasure.py -d ${TDHEAD}/${FEAT}/${num}_${FEAT} -a ${TAHEAD}${num}.GroundTruth -pf ${TPHEAD}${num}_P -em1 ${EMFILE1} -dm1 ${DMFILE1} -p ${num} -ef ${TEFILE} -tf ${TVFILE} -l ${LR} \
